...
{
    let table = $("#reorder_supplier_order_tracker_table").DataTable( 
    {
        columnDefs: [{
                    orderable: false,
    ...
    $("#reorder_supplier_order_tracker_table tbody").on("click", "tr td", function () 
    {
    ...
    $("#proceed_button").on("click", function () 
    {
        ...
        $("#tracker_status_received_modal").modal("show");
    });
